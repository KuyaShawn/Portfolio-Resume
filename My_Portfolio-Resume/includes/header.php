...
<body>
    <header>
        ...
        <aside class="headerContainer">
            ...
            <aside class="icons">
                <a target="_blank" rel="noopener" href="https://github.com/KuyaShawn" title="GitHub @KuyaShawn">
                ...
                <a target="_blank" rel="noopener" href="https://twitter.com/EashuneA" title="Twitter @EashuneA">
                    <svg role="img" viewBox="0 0 24 24">
                        <title>Twitter</title>
                ...
                <a target="_blank" rel="noopener" href="https://discord.com/" title="Discord @Kuya_Shawn#1592">
                    <svg role="img" viewBox="0 0 24 24">
                        <title>Discord</title>
                ...
                <a target="_blank" rel="noopener" href="https://steamcommunity.com/id/DuhBlackJesus/" title="Steam @PotatoSauce">
                    <svg role="img" viewBox="0 0 24 24">
                        <title>Steam</title>
                ...
                <a target="_blank" rel="noopener" href="https://www.instagram.com/kuya__shawn/" title="Instagram @kuya_shawn">
                    <svg role="img" viewBox="0 0 24 24">
                ...
                <a target="_blank" rel="noopener" href="mailto:EashuneAbenojar@hotmail.com" title="E-Mail EashuneAbenojar@hotmail.com">
                    <svg role="img" viewBox="0 0 24 24">
                        <title>E-Mail</title>
