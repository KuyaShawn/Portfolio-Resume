...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        ...
        <a class="navbar-brand nav-link" href="/305/Guessbook/login.php">Login</a>
    ...
    <form action="thank_you.php" method="post" id="guestform">
        ...
        <fieldset class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="url" placeholder="Enter URL" name="linkedin">
        ...
        <fieldset class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="custom-control custom-checkbox">
                    <input class="custom-control-input" type="checkbox" id="add_mailling" value="add_mailling" name="add_mailling">
